...
Public Class CrewProfile
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        '   ScriptManager.RegisterStartupScript(Me.GetType(), "selecttab", "$('#tabs').tabs({ selected: " + hdnCurrent.Value + " });", True)

        ' ClientScript.RegisterStartupScript(Me.GetType(), "selecttab", "$('#tabs').tabs({ selected: " + hdnCurrent.Value + " });", True)
    ...
    Protected Sub Page_PreLoad(sender As Object, e As EventArgs) Handles Me.PreLoad
        ...
        If Not Page.IsPostBack Then
            ...
            If Session("Access") = "P" Then
                ...
                btnAddHistory.Attributes.Add("Class", "hidden")
                btnGo1.Attributes.Add("Class", "hidden")
                btnAddDoc.Attributes.Add("Class", "hidden")
                btnAddFam.Attributes.Add("Class", "hidden")
                btnAddExSeaservice.Attributes.Add("Class", "hidden")
                '                tabcontract.Attributes.Add("Class", "hidden")
                '    tabpayslip.Attributes.Add("Class", "hidden")
    ...
    Public Function ViewRecord(ByVal Code As String) As String
        ...
        '    For Each row As DataRow In dt.Rows
        '        Try
        '            ENextKin.Checked = row("IsNOK").ToString
    ...
    Private Sub lbContract_Click(sender As Object, e As EventArgs) Handles lbContract.Click
        ...
        hdnPosition.Value = "OPERATIONS MANAGER"
        'End If
        ...
        params(0) = New Microsoft.Reporting.WebForms.ReportParameter("EmployerName", "BERNIE DELA CRUZ")
    ...
    Private Sub SaveAllottee(ByVal CrewNo As String)
        ...
        'ScriptManager.RegisterStartupScript(Me, Me.GetType(), "Pop", "famclose();", True)
    ...
    Protected Sub gdSeaService_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gdSeaService.RowCommand
        ...
        ElseIf e.CommandName = "ViewSea3" Then
            ...
            hdnSeaServiceCode.Value = e.CommandArgument
            ...
            sbEvaluation.Append("WHERE SeaServiceCode='" & hdnSeaServiceCode.Value & "'")
    ...
    Private Sub btnUpdateSea_Click(sender As Object, e As EventArgs) Handles btnUpdateSea.Click
        ...
        With htParameters
            ...
            .Add("CallSign", MainClass.Library.Command.ExecScalar("Select CallSign from Vessels WHERE VesselName='" & ddlVesselSeaUp.SelectedItem.ToString & "'"))
            .Add("GRT", MainClass.Library.Command.ExecScalar("Select GRT from Vessels WHERE VesselName='" & ddlVesselSeaUp.SelectedItem.ToString & "'"))
            .Add("EngineType", MainClass.Library.Command.ExecScalar("Select EngineType from Vessels WHERE VesselName='" & ddlVesselSeaUp.SelectedItem.ToString & "'"))
            .Add("VesselType", MainClass.Library.Command.ExecScalar("Select LookUpDescription from Vessels v LEFT JOIN GenericLookUp gl ON v.VesselType=gl.LookUpCode WHERE VesselName='" & ddlVesselSeaUp.SelectedItem.ToString & "'"))
            .Add("Flag", MainClass.Library.Command.ExecScalar("Select Flag from Vessels WHERE VesselName='" & ddlVesselSeaUp.SelectedItem.ToString & "'"))
            .Add("VesselName", ddlVesselSeaUp.SelectedItem.ToString)
